...
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd("qutebrowser https://Github.com/"))
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd("org.equicord.equibop"))
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd("betterbird"))
hl.bind(mainMod .. " + SHIFT + X", hl.dsp.exec_cmd("qutebrowser https://x.com/"))
hl.bind(mainMod .. " + SHIFT + Y", hl.dsp.exec_cmd("qutebrowser https://youtube.com/"))
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("qutebrowser https://gemini.google.com"))
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("deezer-enhanced"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("kitty -- tmux new-session -A -s editor nvim"))
