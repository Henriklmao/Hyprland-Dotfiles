import dracula.draw
import os
import qutebrowser.api.config

# Stop LSP from being shit
c = c  # type: ignore
...
# Type: ShellCommand
c.editor.command = ["kitty", "--class", "qutebrowser-editor", "-e", "nvim", "{file}"]
...
c.url.searchengines = {
    ...
    "google-suggestions": "https://suggestqueries.google.com/complete/search?client=firefox&q={}",
}
